...
public:
    ...
    void        AddChild(Window *child, Point &position, Point &size); // создание дочернего окна
    ...
    void        SetPosition(Point &position);                       // устанавливает положение окна в родительском окне
    ...
    virtual bool OnTimer()                                          // в нашей модели только один таймер
    {
        return false;
    }
//    ...
